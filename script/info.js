...
module.exports.run = async function({ api, event, args, prefix, admin }) {
		...
		const CREATORLINK = "https://www.facebook.com/efkidtrapgamer";
		const BOTCREATOR = "Efkidgamer";
		const BOTNAME = "𝙎𝙞𝙢𝙥𝙡𝙚 𝙘𝙝𝙖𝙩𝙗𝙤𝙩 ";
		const FILESOWNER = 𝙚𝙛𝙠𝙞𝙙 𝙜𝙖𝙢𝙚𝙧";
...
⁂ Bot Name: 𝙎𝙞𝙢𝙥𝙡𝙚 𝙘𝙝𝙖𝙩𝙗𝙤𝙩
✧ Bot Admin: 𝙚𝙛𝙠𝙞𝙙 𝙜𝙖𝙢𝙚𝙧
♛ Bot Admin Link: https://www.facebook.com/efkidtrapgamer
❂ Bot Prefix: ${prefix}
